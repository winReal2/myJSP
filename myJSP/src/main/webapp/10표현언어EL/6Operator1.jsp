...
%>
	...
	<!-- EL 3.0 버전부터 대입연산자(=)를 이용하여 값을 대입할 수 있다 -->
	<!-- 값을 대입 후 출력 -->
	...
	<!-- 표현언어(EL)을 이용하면 산술연산시 자동으로 숫자로 변환 (num3, num4) -->
	<!-- div : 나누기 (문자 형태의 연산자) -->
